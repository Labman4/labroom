...
public interface AccessRecordService {
	...
	String findAll(String timestamp, String id, String order, String scrollId);

	String filterByParams(String params, String timestamp, String id, String order, String scrollId);
