...
//        this.authorizationRequestMatcher = PathPatternRequestMatcher.pathPattern(authorizationRequestBaseUri + "/{registrationId}");
//    }
//
...
//        UriComponents uriComponents = UriComponentsBuilder.fromPath(UrlUtils.buildFullRequestUrl(request)).replacePath(request.getContextPath()).replaceQuery((String)null).fragment((String)null).build();
